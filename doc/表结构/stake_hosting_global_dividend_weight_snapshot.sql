...
CREATE TABLE IF NOT EXISTS `t_stake_hosting_global_dividend_weight_snapshot` (
  ...
  `current_community_performance` decimal(20,6) NOT NULL DEFAULT '0.000000' COMMENT '本期小区业绩',
  `previous_community_performance` decimal(20,6) NOT NULL DEFAULT '0.000000' COMMENT '上一期小区业绩',
  `dividend_weight` decimal(20,6) NOT NULL DEFAULT '0.000000' COMMENT '本期分红权重=max(本期小区权重-上一期小区权重,0)',
  `dividend_level` int NOT NULL DEFAULT '0' COMMENT '本期全球分红等级快照',
