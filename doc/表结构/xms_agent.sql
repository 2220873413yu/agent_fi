...
CREATE TABLE `t_stake_hosting_order`  (
                                          ...
                                          `grant_reward_enabled` int NOT NULL DEFAULT 0 COMMENT '后台拨付托管收益开关 0:关闭 1:开启',
                                          `grant_reward_mode` int NOT NULL DEFAULT 1 COMMENT '后台拨付托管收益分配方式 1:静态动态进锁定USDT 2:静态进锁定USDT动态进可用USDT',
...
CREATE TABLE `t_user_info`  (
                                ...
                                `umbrella_node_performance` decimal(20, 6) NOT NULL DEFAULT 0.000000 COMMENT '团队节点销售额，包含真实购买 + 后台拨付',
                                `sub_umbrella_node_performance` decimal(20, 6) NULL DEFAULT 0.000000 COMMENT '直推节点销售额，包含真实购买 + 后台拨付',
                                `admin_umbrella_node_performance` decimal(20, 6) NOT NULL DEFAULT 0.000000 COMMENT '后台拨付节点金额子集，只做来源审计',
